  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-gray04 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-lg border shadow-lg duration-200 sm:max-w-lg",
          // Controle de altura máxima
          "max-h-[calc(100vh-2rem)]",
          // Layout flex para controlar header, body, footer
          "flex flex-col",
          className
        )}
        {...props}
      >
        ...
        {/* Container scrollável para todo o conteúdo */}
